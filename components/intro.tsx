...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem] z-50"
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="rounded-full object-cover shadow-xl w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48"
            />
          </motion.div>
      ...
      >
        ...
        <a
          className="bg-white p-[14px] text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-lg focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
